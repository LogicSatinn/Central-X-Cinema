                    ...
                    <div class="row mt-5 align-items-center">
                        ...
                        <div class="col">
                            <div class="row align-items-center">
                                <div class="col-md-5">
                                    <p class="small mb-3"><span class="badge badge-dark">@foreach($movie->genre as $genre) {{$genre->name}} @endforeach</span></p>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input class="form-control" name="movie_id" value="{{$movie->id}}" placeholder="{{$movie->name}}" hidden>
                        </div>
