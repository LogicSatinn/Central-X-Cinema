...
class MovieController extends Controller
{
    ...
    public function store(StoreMovieRequest $request)
    {
        ...
        return redirect(route('movies.index'))->withToastSuccess('Movie stored successfully');
    }
    ...
    public function update(UpdateMovieRequest $request, Movie $movie)
    {
        ...
        return redirect(route('movies.index'))->withToastSuccess('Movie updated successfully');
    }
    ...
    public function destroy(Movie $movie)
    {
        ...
        return redirect(route('movies.index'))->withToastSuccess('Movie deleted successfully');
    }
}
